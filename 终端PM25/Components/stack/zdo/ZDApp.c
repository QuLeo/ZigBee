...
void ZDO_NetworkFormationConfirmCB( ZStatus_t Status )
{
  ...
  if ( Status == ZSUCCESS )
  {
    ...
    HalLedSet ( HAL_LED_1, HAL_LED_MODE_ON );//  HalLedSet ( HAL_LED_3, HAL_LED_MODE_ON ); 2017 2 13 huang
  ...
  {
    HalLedSet ( HAL_LED_1, HAL_LED_MODE_OFF );      //2017 2 13 huang ÉèÖÃµÆÉÁË¸ºóµÄ×´Ì¬
    HalLedSet ( HAL_LED_1, HAL_LED_MODE_FLASH );  //HAL_LED_3 2017 2 13 huang Flash LED to show failure
  }
#endif
...
void ZDO_StartRouterConfirmCB( ZStatus_t Status )
{
  ...
  if ( Status == ZSUCCESS )
  {
    ...
    HalLedSet ( HAL_LED_1, HAL_LED_MODE_ON );//HalLedSet ( HAL_LED_3, HAL_LED_MODE_ON ); 2017 2 13
    // LED off forgets HOLD_AUTO_START
    //HalLedSet ( HAL_LED_4, HAL_LED_MODE_OFF);
    if ( devState == DEV_HOLD )
    {
